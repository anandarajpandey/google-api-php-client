...
use GoogleApi\Service\ServiceResource;
   ...
   * Typical usage is:
   *  <code>
   *   $groupssettingsService = new GroupssettingsService(...);
 ...
 * @author Google, Inc.
 */
class GroupssettingsService extends Service {
  public $groups;
  /**
