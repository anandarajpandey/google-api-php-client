 ...
 * @author Google, Inc.
 */
class CustomsearchService extends Service {
  public $cse;
  /**
...
class ResultLabels extends Model {
  public $displayName;
  public $name;
...
class SearchSearchInformation extends Model {
...
class SearchSpelling extends Model {
