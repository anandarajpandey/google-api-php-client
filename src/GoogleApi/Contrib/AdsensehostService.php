...
use GoogleApi\Service\ServiceResource;
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new AdSenseHostService(...);
   ...
   *  </code>
   */
  class AssociationsessionsServiceResource extends ServiceResource {
    ...
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new AssociationSession($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class AdSenseHostService extends Service {
  public $accounts;
...
class AssociationSession extends Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
